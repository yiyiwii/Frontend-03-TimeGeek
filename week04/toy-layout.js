...
function layout(element) {
    ...
    if (mainSpace < 0) {
        // overflow (happens only if container is a single line), scale every item
        var scale = style[mainSize] / (style[minSize] - mainSpace);
        ...
        flexLines.forEach(function (items) {
            ...
            } else { // No flexible flex items, *justifyConten* should work
    ...
    flexLines.forEach(function (items) {
        ...
        crossBse += crossSign * (lineCrossSize + step);
    });
}
